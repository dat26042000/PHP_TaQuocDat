			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-4 pr-md-0">
                  <div class="auth-left-wrapper">
                  	<img style="width: 100%; height: 780px;" src="../assets/backend/images/ass.jpg">
                  </div>
                </div>
                <div class="col-md-8 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo d-block mb-2">Nhom 19</a>
                    ...
                    <form class="forms-sample" method="post" action="index.php?controller=login&action=registerPost">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="thoi_quen" required class="form-control" id="exampleInputPassword1" autocomplete="current-password" placeholder="Thói quen">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Sở thích</label>
                        <input type="text" name="so_thich" required class="form-control" id="exampleInputPassword1" autocomplete="current-password" placeholder="Sở thích">
                      </div>
                      <div class="form-group">
